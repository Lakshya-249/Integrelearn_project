...
const Course4 = () => {
  ...
  const courseData = {
    ...
    features: [
      ...
      "Effective test-taking stratergies",
  ...
  return (
    <div className="container w-11/12 relative left-16 rounded-full">
      <div className="bg-[#eade6c] shadow-md h-[46rem] rounded-lg p-8">
        {/* Course title */}
